...
export const FORMATIONS: Formation[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "slot-4", role: "LM", x: 15, y: 50 },
      { id: "slot-5", role: "CDM", x: 35, y: 60 },
      { id: "slot-6", role: "CAM", x: 50, y: 40 },
      { id: "slot-7", role: "CDM", x: 65, y: 60 },
      { id: "slot-8", role: "RM", x: 85, y: 50 },
      { id: "slot-9", role: "ST", x: 35, y: 20 },
      { id: "slot-10", role: "ST", x: 65, y: 20 },
    ],
  },
  {
    ...
    slots: [
      ...
      { id: "slot-3", role: "CB", x: 65, y: 78 },
      { id: "slot-4", role: "RB", x: 85, y: 75 },
      { id: "slot-5", role: "CDM", x: 50, y: 65 },
      { id: "slot-6", role: "LM", x: 15, y: 45 },
      { id: "slot-7", role: "CM", x: 35, y: 45 },
      { id: "slot-8", role: "CM", x: 65, y: 45 },
      { id: "slot-9", role: "RM", x: 85, y: 45 },
      { id: "slot-10", role: "ST", x: 50, y: 15 },
    ],
  },
  {
    ...
    slots: [
      ...
      { id: "slot-2", role: "CB", x: 50, y: 78 },
      { id: "slot-3", role: "CB", x: 75, y: 78 },
      { id: "slot-4", role: "LM", x: 15, y: 55 },
      { id: "slot-5", role: "CM", x: 35, y: 55 },
      { id: "slot-6", role: "CM", x: 65, y: 55 },
      { id: "slot-7", role: "RM", x: 85, y: 55 },
      { id: "slot-8", role: "CAM", x: 30, y: 30 },
      { id: "slot-9", role: "CAM", x: 70, y: 30 },
      { id: "slot-10", role: "ST", x: 50, y: 15 },
    ],
  },
];
